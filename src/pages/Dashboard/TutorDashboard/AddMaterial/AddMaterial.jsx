      ...
      <div className="max-w-xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-base-content/70 mt-2">
            Share resources for your study sessions
          </p>
          ...
          {sessions.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-base-content/60">
                You have no sessions to upload materials for.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* Session Dropdown */}
              <div>
                <label className="flex items-center gap-2 text-sm font-medium text-base-content/80 mb-1">
                ...
                <select
                  ...
                  className={`w-full select select-bordered bg-base-100 text-base-content focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full input input-bordered bg-base-100 text-base-content focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 ${
              ...
              <div>
                <label className="flex items-center gap-2 text-sm font-medium text-base-content/80 mb-1">
                  <Text className="w-4 h-4 text-indigo-600" />
                  Description
                </label>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full input input-bordered bg-base-200 cursor-not-allowed text-base-content/70"
                />
              </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`btn w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg flex items-center justify-center gap-2 border-0 ${
                  isSubmitting || sessions.length === 0
