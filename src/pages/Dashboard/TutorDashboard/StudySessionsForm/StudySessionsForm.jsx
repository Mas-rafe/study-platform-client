...
const StudySessionsForm = () => {
  ...
  const uploadToImgBB = async (file) => {
    ...
    if (!apiKey) {
      throw new Error("Add VITE_IMGBB_API_KEY to .env");
    }
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const sessionData = {
        ...
        classStart: new Date(
          `${data.classStart}T${data.classStartTime}`
        ).toISOString(),
  ...
  return (
    <div className="min-h-screen bg-base-200 text-base-content py-8 px-4 transition-colors duration-300">
      <motion.div
        ...
        className="max-w-4xl mx-auto bg-base-100 text-base-content rounded-2xl shadow-xl p-8 md:p-10 border border-base-300"
      >
        {/* Header */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
        ...
        >
          ...
          <p className="text-base-content/70 mt-2 text-lg">
            Engage your students with a new learning experience
          </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          >
            ...
            <label
              ...
              className="cursor-pointer flex flex-col items-center justify-center w-80 h-48 border-2 border-dashed border-base-300 rounded-xl hover:border-indigo-400 hover:bg-base-200 transition-all duration-300"
            >
              {imagePreview ? (
                <motion.img
                  initial={{ opacity: 0 }}
          ...
          >
            <div>
              ...
              <input
                ...
                className="input input-bordered w-full rounded-lg bg-base-100 text-base-content border-base-300 focus:border-indigo-500 focus:ring-indigo-500 transition-all"
              />
          ...
          >
            ...
            <textarea
              ...
              className="textarea textarea-bordered w-full rounded-lg bg-base-100 text-base-content border-base-300 focus:border-indigo-500 focus:ring-indigo-500 transition-all"
            />
          ...
          >
            <button
              ...
              className={`btn w-full rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 border-0 ${
